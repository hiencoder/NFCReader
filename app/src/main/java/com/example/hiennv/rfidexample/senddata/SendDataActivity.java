package com.example.hiennv.rfidexample.senddata;
...
public class SendDataActivity extends AppCompatActivity {
    public static final String TAG = SendDataActivity.class.getSimpleName();
    Button btnSendData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSendData = findViewById(R.id.btn_send_file);
