...
public class NFCUtils {
    ...
    private static final String CARD_ID = "carId:";

    public static String getCarId(NdefMessage[] msgs) {
    ...
    public static String getMsgs(NdefMessage[] msgs) {
        if (msgs == null || msgs.length == 0)
            return "";
    ...
    public static String dumpTagData(Tag tag) {
        ...
        sb.append(CARD_ID).append(toDec(id));
        return sb.toString();
